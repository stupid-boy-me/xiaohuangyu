...
print("*" * 30 + " onehot Coding " + "*" * 30)
print("*" * 30 + " Coding success " + "*" * 30)
...
print("model-1-DecisionTreeClassifier is over")
'''
第五步：model-2-KNN
'''
...
print("model-2-KNN")
print("*" * 30 + " accuracy " + "*" * 30)
print("model-2-KNeighborsClassifier accuracy is ：",score)
print("model-2-KNN is over")
'''
第五步：model-3-随机森林分类器
       n_jobs: -1表示设置为核心数量
       n_estimators: 决策树数目
...
print("model-3- RandomForestClassifier")
print("*" * 30 + " Hyperparametric grid search " + "*" * 30)
...
print("model-3- RandomForestClassifier is over")
